...
#ifndef  AUDIO_DIGITAL_H
#define  AUDIO_DIGITAL_H
 ...
 *
 */
enum digital_audio_method{
    DIGITAL_AUDIO_METHOD_UNKOWN = 0,
    DIGITAL_AUDIO_METHOD_1 = 1,
    DIGITAL_AUDIO_METHOD_2 = 2,
    DIGITAL_AUDIO_METHOD_3 = 3,
};
