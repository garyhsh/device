...
PRODUCT_COPY_FILES += \
	...
	device/softwinner/fiber-w01/needfix.rle:root/needfix.rle \
	device/softwinner/fiber-w01/media/bootanimation.zip:system/media/bootanimation.zip \
	device/softwinner/fiber-w01/media/boot.wav:system/media/boot.wav

#key and tp config file
PRODUCT_COPY_FILES += \
	device/softwinner/fiber-w01/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
	device/softwinner/fiber-w01/gslX680.idc:system/usr/idc/gslX680.idc \
	device/softwinner/fiber-w01/gsensor.cfg:system/usr/gsensor.cfg
...
# camera
PRODUCT_COPY_FILES += \
	device/softwinner/fiber-w01/camera.cfg:system/etc/camera.cfg \
	device/softwinner/fiber-w01/media_profiles.xml:system/etc/media_profiles.xml \
